        ...
        <div class="row">
            <div class="col-8 col-lg-4 bg-light shadow-lg m-5 p-5 mx-auto rounded-5">
                <form action="" method="post">
                    ...
                    <div class="text-center">
                        <button class="btn btn-sm w-50 py-2 text-white fw-bold  rounded-pill" id="colorButton" type="submit">Sign in</button>
                        <p class="mt-3 mb-3 text-body-secondary text-end">&copy; <?php echo date("d/m/Y"); ?> </p>
                    </div>
