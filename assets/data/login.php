...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($admin && password_verify($password, $admin["password"])) {
        ...
        header("Location: admin_fhltravel.php"); // Redirection après connexion
        exit;
    } else {
            ...
            <div class="col-8 col-lg-3 bg-light shadow m-5 p-3 mx-auto rounded-2">
                <form action="" method="post">
                    <div class="text-center">
                        <img class="mx-auto rounded-circle" src="../images/logo.png" alt="" width="100" height="100">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="username" id="1" placeholder="your username" required>
                    </div>

                    <div class="mb-3">
                        <label for="2" class="form-label">Email address</label>
                        <input type="password" class="form-control" name="password" id="2" placeholder="your username" required>
                    </div>
                    <div class="text-center">
                        <button class="btn btn-sm w-50 py-2 text-white fw-bold  rounded-pill colorbouton" type="submit">Sign in</button>
                        <p class="mt-3 mb-3 text-body-secondary text-center">&copy; <?php echo date("l, F j, Y") ?> Tech FHL Madagascar </p>
                    </div>
