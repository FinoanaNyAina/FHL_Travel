...
try {
    ...
    $stmtClasseur = $pdo->prepare("SELECT * FROM booking WHERE id = :id");
    $stmtClasseur->execute(["id" => $id]);
    $booking = $stmtClasseur->fetch(PDO::FETCH_ASSOC);
    ...
    <main class=" shadow bg-white rounded p-3">
        ...
        <div class="container mx-auto">
            <div class="text-start p-4 mt-4 bg-success bg-opacity-10 shadow-sm">
                <h2>BOOKING TOUR <br>
                    <p class="fs-5"> NOM : <u><i class="text-primary-emphasis"><?= htmlspecialchars($booking["name"]) ?></i></u> <br>
                        DOSSIER N°: <u><i class="text-primary-emphasis"><?= htmlspecialchars($booking["id"]) ?></i></u>
                    </p>
            ...
            <div class=" row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Date d'Arrivée :</strong> <br>
                            <?= htmlspecialchars($booking["arrival"]) ?>
                        </p>
                    </div>
                    ...
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Adultes :</strong> <br>
                            <?= htmlspecialchars($booking["adults"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Enfants :</strong> <br>
                            <?= htmlspecialchars($booking["children"]) ?>
                        </p>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>travel style</strong> <br>
                            <?= htmlspecialchars($booking["travelstyle"]) ?>
                        </p>
                    </div>
