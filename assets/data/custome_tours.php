    ...
    <main class=" shadow-sm bg-white shadow px-0">
        ...
        <div class="row py-4 px-5 ">
            ...
            <div class="col-12 col-lg-6 ">
                ...
                <h4 class="color "> The Itinerary : <b class=" border p-2 bg-success bg-opacity-25 shadow-sm ">
                        <?php echo $sendprice;  ?>
                    </b> </h4> <br>
                ...
                <div class="m-4 p-3 bg-warning bg-opacity-10 shadow-sm">
                    ...
                    <div class="text-center">
                        <form action="book_now.php" method="post">
                            ...
                            <a href="../../content/personal_adventure.html" class="btn colorbouton rounded-pill "> <svg
