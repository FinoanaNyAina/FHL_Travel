...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $arrival = $_POST["arrival"]; // Type DATE (YYYY-MM-DD)
    $departure = $_POST["departure"]; // Type DATE (YYYY-MM-DD)
    $adults = htmlspecialchars($_POST["adults"]);
    $children = htmlspecialchars($_POST["children"]);
    $room = htmlspecialchars($_POST["room"]);
    $fitness = htmlspecialchars($_POST["fitness"]);
    $autreinfo = htmlspecialchars($_POST["autreinfo"]);
    $avis = htmlspecialchars($_POST["avis"]);

    // ✅ Gérer les checkboxes multiples correctement
    function getCheckboxValues($name)
    {
        return isset($_POST[$name]) ? implode(", ", $_POST[$name]) : "";
    }

    $travelstyle = getCheckboxValues("travelstyle");
    $wildlife = getCheckboxValues("wildlife");
    $park = getCheckboxValues("park");
    $road = getCheckboxValues("road");
    $air = getCheckboxValues("air");
    $food = getCheckboxValues("food");
    $guide = getCheckboxValues("guide");
    $ability = getCheckboxValues("ability");
    $budget = getCheckboxValues("budget");
    ...
    try {
        ...
        // Insérer les données
        $stmt = $pdo->prepare("
            INSERT INTO createTours (email, name, adresse, phone, arrival, departure, adults, children, room, travelstyle, 
            wildlife, park, road, air, food, guide, fitness, ability, autreinfo, budget, avis) 
            VALUES (:email, :name, :adresse, :phone, :arrival, :departure, :adults, :children, :room, :travelstyle, 
            :wildlife, :park, :road, :air, :food, :guide, :fitness, :ability, :autreinfo, :budget, :avis)
        ");
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Karla:ital,wght@0,200..800;1,200..800&family=Madimi+One&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Nunito:ital,wght@0,200..1000;1,200..1000&family=Open+Sans:ital,wght@0,300..800;1,300..800&family=Patrick+Hand+SC&family=Special+Elite&family=Spectral:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;1,200;1,300;1,400;1,500;1,600;1,700;1,800&family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap" rel="stylesheet">
         ...
         <link rel="stylesheet" href="../css/globalcss.css?v=<?= filemtime('../css/globalcss.css'); ?>">
   ...
   <div class="container bg-black bg-opacity-25 rounded none fw-bold">
            ...
            <div class="row ">
                <div class=" col-11 col-lg-8">
                    <ul class="nav">
                        ...
                        <li>
                            <a href="" target="_blank" class="nav-link px-2 text-white a">
                ...
                <div class=" col-1 col-lg-4  ">
                    <ul class="nav justify-content-end">
                        <li class="">
                            <a href="login.php" class="nav-link px-2 text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
    ...
    <main class=" shadow-sm bg-white shadow px-0">
        <div style="height: 100vh; display: flex; justify-content: center; align-items: center;">
            ...
            <div class=" col-md-11 col-lg-11 mx-auto g-0 p-5 bg-light rounded-4 shadow-lg">
                <div class="row">
                    <div class="col-lg-4 text-center"><img src="../images/logo.png" alt="Logo" width="200" height="200"
                            class="rounded-circle"></div>
                    <div class="col-lg-8">
                        <h3>Your request Sent <span class="badge text-bg-light"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <p>Dear <b class="text-primary-emphasis"> <?php echo  $name; ?></b>, <br><br>

                            Thank you for reaching out to <span class="text-primary-emphasis">FHL Madagascar
                                Travel</span> and
                            choosing us to plan your
                            personalized tour in Madagascar! We
                            truly appreciate the trust you've placed in our team, and we are excited to help you create
                            an unforgettable travel
                            experience. 🌍✨ <br><br>

                            Our team is already reviewing the details of your request, and we will respond to you as
                            soon as possible with the
                            information and itinerary based on the preferences you’ve shared. Rest assured, we are
                            working to provide you with the
                            best possible options for your adventure. <br><br>

                            If you have any additional questions or need further assistance, feel free to contact us at
                            <span class="text-primary-emphasis"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-envelope-at" viewBox="0 0 16 16">
                                    <path
                                        d="M2 2a2 2 0 0 0-2 2v8.01A2 2 0 0 0 2 14h5.5a.5.5 0 0 0 0-1H2a1 1 0 0 1-.966-.741l5.64-3.471L8 9.583l7-4.2V8.5a.5.5 0 0 0 1 0V4a2 2 0 0 0-2-2zm3.708 6.208L1 11.105V5.383zM1 4.217V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v.217l-7 4.2z" />
                                    <path
                                        d="M14.247 14.269c1.01 0 1.587-.857 1.587-2.025v-.21C15.834 10.43 14.64 9 12.52 9h-.035C10.42 9 9 10.36 9 12.432v.214C9 14.82 10.438 16 12.358 16h.044c.594 0 1.018-.074 1.237-.175v-.73c-.245.11-.673.18-1.18.18h-.044c-1.334 0-2.571-.788-2.571-2.655v-.157c0-1.657 1.058-2.724 2.64-2.724h.04c1.535 0 2.484 1.05 2.484 2.326v.118c0 .975-.324 1.39-.639 1.39-.232 0-.41-.148-.41-.42v-2.19h-.906v.569h-.03c-.084-.298-.368-.63-.954-.63-.778 0-1.259.555-1.259 1.4v.528c0 .892.49 1.434 1.26 1.434.471 0 .896-.227 1.014-.643h.043c.118.42.617.648 1.12.648m-2.453-1.588v-.227c0-.546.227-.791.573-.791.297 0 .572.192.572.708v.367c0 .573-.253.744-.564.744-.354 0-.581-.215-.581-.8Z" />
                                </svg>contact@fhltravel.com</span> or <span class="text-primary-emphasis"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-whatsapp" viewBox="0 0 16 16">
                                    <path
                                        d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.9 7.9 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.9 7.9 0 0 0 13.6 2.326zM7.994 14.521a6.6 6.6 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.56 6.56 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592m3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.73.73 0 0 0-.529.247c-.182.198-.691.677-.691 1.654s.71 1.916.81 2.049c.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232" />
                                </svg> +261 32 95 720 20 </span>. <br><br>

                            We look forward to making your dream trip a reality!
                        </p>
