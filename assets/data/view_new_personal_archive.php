...
<body class="bg f">
            ...
            <header class="d-flex flex-wrap justify-content-center justify-content-md-between py-1 mt-2">
                ...
                <div class="col-auto col-md-3 text-end pt-2">
                    <div class="row">
                        ...
                        <div class="col g-0"><a class="btn text-white f fw-bold g-0 rounde-pill " id="colorButton"
    ...
    <main class=" shadow bg-white rounded p-3">
        ...
        <div class="mx-4">
            <div class="text-start p-4 mt-4 bg-success bg-opacity-10 shadow-sm">
                <h2>LES DOSSIER EN ClASSER <br>
                    <p class="fs-5"> NOM : <u><i class="text-primary-emphasis"><?= htmlspecialchars($classeur["name"]) ?></i></u> <br>
                        DOSSIER N°: <u><i class="text-primary-emphasis"><?= htmlspecialchars($classeur["id"]) ?></i></u>
                    </p>
                ...
                <div class="col-lg-6">
                    <div class=" bg-light shadow-sm m-3" id="nav">
                        <p><strong>Nom :</strong> <br>
                            <?= htmlspecialchars($classeur["name"]) ?>
                        </p>
                    </div>

                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Email :</strong> <br>
                            <?= htmlspecialchars($classeur["email"]) ?>
                        </p>
                    </div>

                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Adresse :</strong> <br>
                            <?= htmlspecialchars($classeur["adresse"]) ?>
                        </p>
                    </div>

                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Téléphone :</strong> <br>
                            <?= htmlspecialchars($classeur["phone"]) ?>
                        </p>
                    </div>

                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Date d'Arrivée :</strong> <br>
                            <?= htmlspecialchars($classeur["arrival"]) ?>
                        </p>
                    </div>

                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Date de Départ :</strong> <br>
                            <?= htmlspecialchars($classeur["departure"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Adultes :</strong> <br>
                            <?= htmlspecialchars($classeur["adults"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Enfants :</strong> <br>
                            <?= htmlspecialchars($classeur["children"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Chambre :</strong> <br>
                            <?= htmlspecialchars($classeur["room"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Style de voyage :</strong> <br>
                            <?= htmlspecialchars($classeur["travelstyle"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Vie sauvage :</strong> <br>
                            <?= htmlspecialchars($classeur["wildlife"]) ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Parc :</strong> <br>
                            <?= htmlspecialchars($classeur["park"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Route :</strong> <br>
                            <?= htmlspecialchars($classeur["road"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Air :</strong> <br>
                            <?= htmlspecialchars($classeur["air"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Nourriture :</strong> <br>
                            <?= htmlspecialchars($classeur["food"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Guide :</strong> <br>
                            <?= htmlspecialchars($classeur["guide"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Condition physique :</strong> <br>
                            <?= htmlspecialchars($classeur["fitness"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Capacité :</strong> <br>
                            <?= htmlspecialchars($classeur["ability"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Infos supplémentaires :</strong> <br>
                            <?= htmlspecialchars($classeur["autreinfo"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Budget :</strong> <br>
                            <?= htmlspecialchars($classeur["budget"]) ?>
                        </p>
                    </div>
                    <div class=" bg-light shadow-sm m-3">
                        <p><strong>Avis :</strong> <br>
                            <?= htmlspecialchars($classeur["avis"]) ?>
                        </p>
                    </div>
        ...
        <div class="text-center m-5 ">
            <a href="admin_fhltravel.php" class="btn btn-warning ">Retour</a>
