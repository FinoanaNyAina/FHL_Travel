...
try {
    ...
    $pots = $bb->fetchAll(PDO::FETCH_ASSOC);

    // Récupérer les détails du classeur
    $stmtClasseur = $pdo->prepare("SELECT * FROM new WHERE id = :id");
    $stmtClasseur->execute(["id" => $id]);
    $new = $stmtClasseur->fetch(PDO::FETCH_ASSOC);
...
<head>
    ...
    <meta name="description"
        content="Recent updates on tourism in Madagascar.">
...
<body class="bg f">
            ...
            <header class="d-flex flex-wrap justify-content-between align-items-center p-2">
                ...
                <ul class="nav d-none d-md-flex col-md-6 justify-content-center mb-2 mb-md-0 mx-auto" id="nav">
                    ...
                    <li><a href="Madagascar_tourism_new.php"
                            class="nav-link px-2 text-white  border-bottom border-warning border-2">News</a>
                    </li>
    ...
    <main class=" shadow bg-light rounded p-3">
                    ...
                    <div class="row g-1">
                        <div class=" col-12 col-lg-8 mx-auto">
                            <div class=" text-start">
                                <p> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="text-warning bi bi-calendar3" viewBox="0 0 16 16">
                                        <path d="M14 0H2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M1 3.857C1 3.384 1.448 3 2 3h12c.552 0 1 .384 1 .857v10.286c0 .473-.448.857-1 .857H2c-.552 0-1-.384-1-.857z" />
                                        <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2m3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
                                    </svg> <?= $new["date"] ?> | update on <?= $new["time"] ?>
                                </p>
                            </div>

                            <div class="text-center">
                                <p class="fs-3 uppercase color titre ligne"><?= $new["titre"] ?></p>
                            </div>

                            <div class=" pb-4 pt-1 rounded-2 bg-white shadow-sm rounded-1 ">

                                <div class="card rounded-2">
                                    <img src="<?= $new["image"] ?>" class="rounded-2 card-img" alt="">
                                </div>
                            ...
                            <div class="px-1 pt-1 rounded-2 ">
                                ...
                                <?php foreach ($pots as $singial): ?>
                                    <div class="col-11 rounded  m-3 ">
                                        ...
                                        <a href="news.php?id=<?= htmlspecialchars(intval($singial['id'])); ?>" class="" style="text-decoration: none;">

                                            <div class="card h-100 rounded-2 border-0 shadow-sm">
                                                <div class="bb">
                                                    <?php if (!empty($singial["image"])): ?>
                                                        <img src="<?= $singial["image"]; ?>" class="card-img" alt="Image" style=" height: 250px; object-fit: cover; width: 100%;">
                                                    <?php endif; ?>

                                                </div>
                                                <div class="card-body ">
                                                    <p class="card-text"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                                    ...
                                                    <h5 class="card-title"><?= $singial["titre"]; ?></h5>
                                                </div>
                                            </div>
                                        </a>
        ...
        <div class="m-4 text-center ">
            <a href="Madagascar_tourism_new.php" class="btn whatsapp rounded-pill btn-lg fw-bold" id="nav"> Return</a>
