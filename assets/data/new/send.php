...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $datetimeformat = (new DateTime($time))->format("l, F j, Y");
        ...
        $stmt = $pdo->prepare("
            INSERT INTO new (contenu, image, titre, date, time) 
            VALUES (:message, :file_path, :titre, :date, :time)
        ");
    ...
    <main class=" shadow-sm bg-white shadow px-0">
        <div style="height: 100vh; display: flex; justify-content: center; align-items: center;">
            ...
            <div class="col-12 col-md-8 col-lg-6 mx-auto g-0 p-5 bg-light rounded-4 shadow-lg">
                <div class="row">
                    <div class="  col-md-6 col-lg-6"><img src="../../images/logo.webp" alt="Logo" width="200" height="200"
