    ...
    <main class=" shadow-sm bg-white shadow px-0">
        <div style="height: 100vh; display: flex; justify-content: center; align-items: center;">
            ...
            <div class="col col-md-8 col-lg-8 mx-auto  p-5 bg-light rounded-4 shadow-lg">
                <div class="row">
                    <div class="col "><img src="../images/logo.png" alt="Logo" width="200" height="200"
                            class="rounded-circle"></div>
                    <div class="col">
                        <h3>Your data Sent <span class="badge text-bg-light"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a href="../data/admin_fhltravel.php" class="btn btn-sm whatsapp rounded-pill"> Back to </a>
                    </div>
