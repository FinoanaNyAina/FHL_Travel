        ...
        <div class=" container mx-auto">
            <div class="text-start p-4 mt-4 bg-info bg-opacity-10 shadow-sm">
                <h2>PERSONAL TOURS <br>
                    <p class="fs-5"> NOM : <u><i class="text-primary-emphasis"><?= htmlspecialchars($contact["name"]) ?></i></u> <br>
                        DOSSIER N°: <u><i class="text-primary-emphasis"><?= htmlspecialchars($contact["id"]) ?></i></u>
                    </p>
