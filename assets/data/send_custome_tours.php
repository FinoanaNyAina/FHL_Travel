...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Insert data
        $stmt = $pdo->prepare("
            INSERT INTO booking (tour, arrival, departure, adults, children, travelstyle, message, name, email, phone ) 
            VALUES (:tour, :arrival, :departure, :adults, :children, :travelstyle, :message, :name, :email, :phone )
        ");
    ...
    <main class=" shadow-sm bg-white shadow px-0">
        <div style="height: 100vh; display: flex; justify-content: center; align-items: center;">
            ...
            <div class="col-12 col-md-8 col-lg-6 mx-auto g-0 p-5 bg-light rounded-4 shadow-lg">
                <div class="row">
                    <div class="  col-md-6 col-lg-6 text-center"><img src="../images/logo.png" alt="Logo" width="200"
                    ...
                    <div class="  col-md-6 col-lg-6">
                        ...
                        <p><b class="text-primary-emphasis">Thank you "
                                <?php echo $name; ?>"
                            </b> for booking your tour! We have received your request and will contact you shortly to
                            confirm the details. 💙 </p>
                        <a href="../../index.php" class="btn btn-sm whatsapp rounded-pill fw-bold"> Back to Home </a>
