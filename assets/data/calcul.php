...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $jours = isset($_POST["day"]) ? intval($_POST["day"]) : 0;
    ...
    // Fonction pour récupérer et additionner les valeurs des checkboxes cochées
    function getCheckboxValues($name)
    {
        // Vérifier si des checkboxes sont cochées et les additionner
        if (isset($_POST[$name])) {
            // Additionner toutes les valeurs des checkboxes cochées
            return array_sum($_POST[$name]);
        }
        return 0; // Retourne 0 si aucune checkbox n'est cochée
    }

    // Récupérer la somme des valeurs des checkboxes cochées
    $totalHotelMedium = getCheckboxValues("mediumhotel");
    $totalLux = getCheckboxValues("lux");
    $totalPark = getCheckboxValues("park");
    $totalBas = getCheckboxValues("bas");
    $totalBaque = getCheckboxValues("baque");

    // Afficher le total



    $total = $totalHotelMedium + $totalBas + $totalLux + $totalPark + $totalBaque + ((($jours * $location) + ((($km * 15) / 100) * 4900))) + $extra;
}
?>
...
<body class="bg f">
   ...
   <div class="container bg-black bg-opacity-25 rounded none fw-bold">
    ...
    <main class="shadow-sm bg-white shadow px-0">
        <div class="mx-auto col-lg-6 py-5 ">
            <p>Hôtel medium : <b> <?= number_format($totalHotelMedium, 0, ".", " ") . " Ariary" ?> </b></p>
            <p>Hôtel Bas de gamme : <b> <?= number_format($totalBas, 0, ".", " ") . " Ariary" ?> </b></p>
            <p>Hôtel Lux : <b> <?= number_format($totalLux, 0, ".", " ") . " Ariary" ?> </b></p>
            <p>Prix Park : <b> <?= number_format($totalPark, 0, ".", " ") . " Ariary" ?> </b></p>
            <p>Baque : <b> <?= number_format($totalBaque, 0, ".", " ") . " Ariary" ?> </b></p>
            <p>Location et carburant : <b> <?= number_format($location_gasoil, 0, ".", " ") ?> </b></p>
            <p>Les extras : <b> <?= number_format($extra, 0, ".", " ") ?> </b></p> <br><br>
            <div class="bg-warning bg-opacity-10 p-5">
                <p>TOTAL : <b> <?= number_format($total, 0, ".", " ") . " Ariary" ?> </b></p>
                <p>Valeur en <b>euro</b> : <b> <?= number_format($total / 4800, 2, ".", " ") . " Euro" ?> </b></p>
                <p>Valeur en <b>Dollars</b> : <b> <?= number_format($total / 4600, 2, ".", " ") . " Dollars" ?> </b></p>
            </div>
        </div>
    </main>
            ...
            <div class="row">
                ...
                <div class="col-6 col-lg-2 mb-3 text-center">
                    ...
                    <a href="../../content/tours/Day_One_Andasibe.php" class="nav-link p-0 text-white a">- One Day
                        Andasibe</a>
                    <a href="../../content/tours/Tsingy_Ifaty.php" class="nav-link p-0 text-white a">- Tsingy -
                        Ifaty</a>
                    <a href="../../content/tours/NosyBe_Tour.php" class="nav-link p-0 text-white a">- Nosy Be Tour</a>
                    <a href="../../content/tours/wonderSouth_Andasibe.php" class="nav-link p-0 text-white a">- Amazing
                        island
                        of
                        thr South / Andasibe </a>
                    <a href="../../content/tours/exploration&adventure.php" class="nav-link p-0 text-white a">-
                        Exploration
                        and
                        adventure </a>
                    <a href="../../content/tours/colorsofEast.php" class="nav-link p-0 text-white a">- Scents and
                        colors of
                        the
                        East </a>
                    <a href="../../content/tours/Mystic_west_&_RN7_Discovery.php" class="nav-link p-0 text-white a">-
                        Mystic
                        West
                        and RN7 discovery</a>
