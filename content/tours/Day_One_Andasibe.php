    ...
    <main class=" shadow-sm bg-white rounded p-3 shadow">
        ...
        <div class="position-sticky bg-white shadow-sm raccourci " style="top: 4rem;">
            <div class=" row pb-2 pt-1 ">
                ...
                <div class="col-10  col-lg-11 py-2 bg-white  " style="border-radius: 0 10px 10px 0;">
                    ...
                    <a href="wonderSouth.php" style="text-decoration: none;">wonderSouth</a> | Day One Andasibe
        ...
        <div class="row txt">
            <div class="col-md-12 p-3">
                <div class="row ">
                    <div class="col-lg-4">
                        <img src="../../assets/images/indriindri.webp" class="" alt="" width="100%">

                    </div>
                    <div class=" col-12 col-lg-5">

                        <h1 class="titre" id="titrehtml">ONE DAY TOUR <b>ANDASIBE</b></h1>
                        <figcaption class="blockquote-footer">
                            It is also possible for groups.</cite>
                        </figcaption>
                        <p id="texthtml">
                            Pick up at your hotel and then depart for Andasibe National Park, passing through highland
                            scenery and rice paddies. The
                            drive takes approximately 4 hours' drive and gives you your first glimpse to this culturally
                            and scenically diverse
                            country as you pass rice fields, villages and roadside stalls. Upon arrival; you visit
                            directly Andasibe National Park
                            (Analamazotra reserve) that you will discover the biggest lemur alive in the wild which is
                            the Indri Indri. Try to see
                            as well the diademed or Godlen Sifaka, the brown and the grey bamboo lemurs <span
                                id="dots">...</span>

                            <span id="more">
                                You will discover as well some endemic
                                orchids and medicinal plants some endemic birds Continuation to Vakona private
                                reserve, visit the lemurs Island
                                (the first Island) that you are going to discover the brown, the bamboo and the black
                                and
                                white ruffed lemurs the best
                                time to have a wonderful time with them and you will be able to take a close picture
                                with
                                You will see on the second
                                Island the diademed Sifaka; and the red ruffed. After the visit; drive back to
                                Antananarivo
                                via Marovezo to visit the
                                Peyreiras Reserve or the Exotic Park. You will see the chameleons, some endemic frogs,
                                snakes, Geckos and lemurs. After
                                the visit, continue to Antananarivo (late) and then transfer to your hotel.
                            </span> <br>
                        ...
                        <div class="mt-3">
                            ...
                            <p class="border p-3 bg-danger bg-opacity-10 shadow-sm">The final price of this day tour to
                                Andasibe will vary
                        ...
                        <div class="row rounded-3 shadow bg-warning bg-opacity-10 p-3">
                            <div class="col-12 ">
                                <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    </svg> Total duration : <strong>1 Day</strong>
                    ...
                    <div class="col-12 col-lg-6 ">
                        <div class="border-bottom pb-3 image-hover">
                            <h3 class="titre"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                                ...
                                </svg> DAY 1 : ANTANANARIVO - ANDASIBE </h3>
                            <p>
                                Embark on a full-day adventure to Andasibe, where you'll enjoy a scenic drive from
                                Antananarivo, explore the Andasibe
                                National Park with a guided lemur spotting tour, visit the Vakona Reserve to interact
                                with
                                lemurs, and return to
                                Antananarivo with memories of Madagascar's wildlife and natural beauty.
                            </p>
                        </div>
                        ...
                        <div class="row mt-4 py-3 bg-warning bg-opacity-10 rounded shadow-sm">
                            <div class="col-lg-6 border-end">
                                <div>
                                    ...
                                    <p>- Private vehicle during the tour with a driver English speaking (Fuel included)
                                        <br>
                                        - One bottle of mineral water per person <br>
                                        - Entrance site and local guide fees <br>
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-6  ">
                                <div>
                                    ...
                                    <p>- Lunch <br>
                                        - Tips <br>
                                        - personal expense and none specified items</p>
                                </div>
                            </div>
