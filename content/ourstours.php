...
<head>
    ...
    <meta name="description"
        content="Discover Madagascar, Choose your tour, you can change the tour's configuration as you wish and, customize your tour. Choisissez votre circuit, vous pouvez modifier la configuration du circuit à votre désir et personnaliser votre circuit.">
    ...
    <title>Explore the beauty of Madagascar with our carefully designed tours </title>
...
<body class="bg f">
    ...
    <main class=" shadow-sm bg-light rounded px-3 pb-3 shadow">
        <div class="row mb-2 shadow-sm alltours ">

        </div>
        <div class=" col-12 col-lg-8 mx-auto txt">
            <h1 class="text-center  ligne"> AUTHENTIC TRAVEL </h1>
            <div class="col-12 col-lg-8 mx-auto">
                <p class="mt-4 mb-5 txt">Explore the beauty of Madagascar with our carefully designed tours. From
                    lush
                    rainforests to stunning beaches, unique wildlife, and rich culture, our adventures offer
                    unforgettable
                    experiences across the island. Whether you seek adventure, relaxation, or cultural discovery, we
                    have the
                    perfect tour for you!</p>
        ...
        <div class="row mx-auto mb-5">
            ...
            <!----------------------Tours ----------------------->
            <div class="col-lg-8 shadow-sm mb-3 txt">
                <div class="accordion accordion-flush p-3 position-sticky " style="top: 5rem;"
                    id="accordionFlushExample">
                    <!------------------------------------- Good deals ------------------------------------------->

                    <div class="accordion-item">
                        <h2 class="accordion-header titre ">
                            <button class="accordion-button collapsed bg-info bg-opacity-10 shadow-sm fs-3 fw-bold"
                                type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne"
                                aria-expanded="false" aria-controls="flush-collapseOne">
                                GOOD DEALS<span
                                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger fs-5 ">
                                    4
                            ...
                            <div class="accordion-body ">
                                <div class="row g-3 ">
                                    <div class="col-lg-12 image-hover">
                                        <a href="tours/Day_One_Andasibe.php" class="text-decoration-none text-dark">
                                            <div class="row pb-3 border-bottom shadow-sm ">
                                                <div class="col-lg-6 ">
                                                    ...
                                                    <img src="../assets/images/indriindri.webp" alt="" width="300px">
                                                </div>
                                                <div class="col-lg-6">
                                                    <h3 class="titre"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                        ...
                                                        </svg> ONE DAY ANDASIBE</h3>
                                                    <p>Antananarivo - Andasibe - Antananarivo</p>
                                    ...
                                    <div class="col-lg-12 image-hover">
                                        <a href="../content/tours/Tsingy_Ifaty.php"
                                            class="text-decoration-none text-dark">
                                            <div class="row  pb-3 border-bottom shadow-sm">
                                                <div class="col-lg-6 ">
                                                    <img src="../assets/images/tsingy.webp" alt="" height="100%"
                                                        width="300px">
                                                </div>
                                                <div class="col-lg-6">
                                                    <h3 class="titre"> <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path
                                                                d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0z" />
                                                        </svg> 15 DAY TSINGY - IFATY</h3>
                                                    <p>Antananarivo – Antsirabe – Morondava – Bekopaka – Morondava –
                                                        Antsirabe – Ambositra – Ranomafana – Fianarantsoa –
                                                        Ranohira – Isalo – Toliary – Ifaty.</p>
                                                    <div class="row text-center me-3">
                                                        <div class="col py-2 bg-warning bg-opacity-10 rounded-4 "><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" fill="currentColor" class="bi bi-stopwatch"
                                    ...
                                    <div class="col-lg-12 image-hover">
                                        <a href="../content/tours/NosyBe_Tour.php"
                                            class="text-decoration-none text-dark">
                                            <div class="row  pb-3 border-bottom shadow-sm">
                                                <div class="col-lg-6 ">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <p>Antananarivo – Nosy Be – Nosy Komba – Nosy Taninkely – Nosy
                                    ...
                                    <div class="col-lg-12 image-hover">
                                        <a href="../content/tours/wonderSouth.php"
                                            class="text-decoration-none text-dark">
                                            <div class="row pb-3 border-bottom shadow-sm ">
                                                <div class="col-lg-6 ">
                                                    <img src="../assets/images/city/toliara.webp" alt="" height="100%"
                                                        width="300px">
                                                </div>
                                                <div class="col-lg-6">
                                                    <h3 class="titre"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header titre">
                            <button class="accordion-button collapsed bg-warning bg-opacity-10 shadow-sm fs-3 fw-bold"
                                type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo"
                                aria-expanded="false" aria-controls="flush-collapseTwo">
                                ALL TOURS <span
                                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success shadow-sm fs-5 ">
                                    8
                            </button>
                        </h2>
                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3 ">
                                    ...
                                    <div class="col-lg-12 image-hover">
                                        <a href="../content/tours/wonderSouth_Andasibe.php"
                                            class="text-decoration-none text-dark">
                                            <div class="row  pb-3 border-bottom shadow-sm">
                                                <div class="col-lg-6 ">
                                                    <img src="../assets/images/city/toliara1.webp" alt="" height="100%"
                                                        width="300px">
                                                </div>
                                                <div class="col-lg-6">
                                                    <h3 class="titre"> <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="col-lg-12 image-hover">
                                        <a href="../content/tours/exploration&adventure.php"
                                            class="text-decoration-none text-dark">
                                            <div class="row  pb-3 border-bottom shadow-sm">
                                                <div class="col-lg-6  ">
                                                    <div class="text-end">
                                    ...
                                    <div class="col-lg-12 image-hover">
                                        <a href="../content/tours/colorsofEast.php"
                                            class="text-decoration-none text-dark">
                                            <div class="row  pb-3 border-bottom shadow-sm">
                                                <div class="col-lg-6  ">
                                    ...
                                    <div class="col-lg-12 image-hover">
                                        <a href="../content/tours/Mystic_west_&_RN7_Discovery.php"
                                            class="text-decoration-none text-dark">
                                            <div class="row  pb-3 border-bottom shadow-sm">
                                                <div class="col-lg-6  ">

                                                    <img src="../assets/images/city/aller.webp" alt="" whidth="100%"
                                                        width="300px">
                                                </div>
                                                <div class="col-lg-6">
                                                    <h3 class="titre"> <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header titre">
                            <button class="accordion-button collapsed bg-danger bg-opacity-10 shadow-sm fs-3 fw-bold"
                                type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree"
                                aria-expanded="false" aria-controls="flush-collapseThree">
                                DAY ONE TOUR <span
                                    class="position-absolute top-0 start-100 translate-middle badge bg-info shadow-sm rounded-pill fs-5 ">New
                            </button>
                        </h2>
            ...
            <div class="col-lg-4 ">
                <div class="position-sticky txt" style="top: 4rem;">
                    <h2 class="titre text-center ligne">Natural Parks and Reserves in Madagascar</h2>
                    <p>In Madagascar, nature and endemic treasures are truly exceptional. As you explore the
                        island's
                        many
                        natural parks and
                        reserves must visit attractions for your next tour you can plan your stops, whether for a
                        short
                        visit of a few hours or
                        an extended eco-tourism and adventure stay over several days.</p>
                    <div class="row">
                        <div class="col mx-auto text-center">
                            <a href="../content/park/park.php" class="btn whatsapp rounded-pill "><svg
                    ...
                    <div class="mt-5">
                        <img src="../assets/images/maps_parks.webp" width="100%" alt="">
                    </div>
                </div>
...
<script src="../assets/js/ourstours.js"></script>
