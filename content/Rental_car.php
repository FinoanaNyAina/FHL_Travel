...
<head>
    ...
    <meta name="description"
        content="Discover Madagascar,Discover the beauty of Madagascar at your own pace with our reliable and comfortable rental cars. Whether you're exploring the stunning landscapes of the south, venturing into the highlands, or heading to the pristine beaches, we provide the perfect vehicle for your journey. .">
...
<body class="bg f">
        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-between align-items-center p-2">
                ...
                <ul class="nav d-none d-md-flex col-md-6 justify-content-center mb-2 mb-md-0 mx-auto" id="nav">
                    ...
                    <li><a href="Rental_car.php" class="nav-link px-2 text-white border-bottom border-warning border-2">Car Rental</a>
                    </li>
    ...
    <main class=" shadow-sm bg-white shadow px-0">
        ...
        <div id="rent" class="p-5 mb-2 text-white ">

        </div>
        <div class="container">
            <div class=" mt-5 border-bottom">
                <div class="text-center txt">
                    <h2 class="d-inline-block mb-2 fw-bold titre text-uppercase text-center color ligne  ">
                        Explore Madagascar with Ease – Rent a Car with <br>FHL Madagascar Travel</h2>

                    <div class="row mt-4 mb-5">
                        <div class="col-8 mx-auto">
                            <p class="">Discover the beauty of Madagascar at your own pace with our reliable and
                                comfortable
                                rental cars. Whether you're
                                exploring the stunning landscapes of the south, venturing into the highlands, or
                                heading to
                                the pristine beaches, we
                                provide the perfect vehicle for your journey.</p>
                        </div>
                    </div>
                    ...
                    <div class="card mb-5 mx-auto">
                        <div class="row g-0">
                            <div class="col-lg-6 ">
                                <img src="../assets/images/teracan.webp" alt="" width="100%">

                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="card-body ">
                                    <h5 class="card-title ">Hyundai Terracan 4WD – Rental for Adventure &
                                        Off-Road
                                    </h5>
                                    <div class="text-start ps-5">
                                        <h6 class="fw-bold">Vehicle Specifications:</h6>
                                        <ul class="">
                                            <li>Brand & Model: Hyundai Terracan</li>
                                            <li>Engine: 2.9 CRDi Diesel, 4-cylinder turbo</li>
                                            <li>Transmission: 4x4 with transfer case (High/Low)</li>
                                            <li>Gearbox: Automatic</li>
                                            <li>Power: Around 150-163 HP</li>
                                            <li>Fuel Consumption: ≈ 13L/100 km</li>
                                            <li>Fuel Tank Capacity: 75L</li>
                                            <li>Seating Capacity: Up to 5 passengers + luggage</li>
                                            <li>Features: Air conditioning, electric windows, radio/CD, power
                                                steering
                                            </li>
                                            <li>Safety: ABS, airbags, reinforced chassis</li>
                                        </ul>

                                        <h6 class="fw-bold">Perfect for:</h6>
                                        <ul>
                                            <li>✅ Off-road & adventure trips</li>
                                            <li>✅ Exploration of Madagascar’s unique landscapes</li>
                                            <li>✅ Long-distance travel on rough terrain</li>
                                        </ul>

                                        <p class="contact"><svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                height="20" fill="currentColor" class="bi bi-geo-alt-fill "
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                                            </svg> Available for rental at FHL Madagascar Travel<br><svg
            ...
            <div class=" mt-5 border-bottom">
                <div class="text-center txt">
                    <div class="card mb-5 mx-auto">
                        <div class="row g-0">
                            <div class="col-lg-6 ">
                                <img src="../assets/images/v96.webp" alt="" width="100%">

                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="card-body ">
                                    <h5 class="card-title ">Mitsubishi Pajero V96 – Rental for Adventure & Comfort
                                    </h5>
                                    <div class="text-start ps-5">
                                        <h6 class="fw-bold">Vehicle Specifications:</h6>
                                        <ul class="">
                                            <li>Brand & Model: Mitsubishi Pajero V96</li>
                                            <li>Engine: 3.2L Diesel or 3.8L Petrol, 4-cylinder turbo</li>
                                            <li>Transmission: 4x4 with Super Select system</li>
                                            <li>Gearbox: Manuel</li>
                                            <li>Power: Around 200-250 HP</li>
                                            <li>Fuel Consumption: ≈ 10-12L/100 km</li>
                                            <li>Fuel Tank Capacity: 88L</li>
                                            <li>Seating Capacity: Up to 7 passengers + luggage</li>
                                            <li>Features: Air conditioning, leather seats (optional), touchscreen display, power steering</li>
                                            <li>Safety: ABS, airbags, traction control, hill descent assist</li>
                                        </ul>

                                        <h6 class="fw-bold">Perfect for:</h6>
                                        <ul>
                                            <li>✅ Off-road & adventure trips</li>
                                            <li>✅ Exploring Madagascar’s diverse landscapes</li>
                                        ...
                                        <p class="contact">
                                            ...
                                            </svg> Available for rental at FHL Madagascar Travel
                                            <br>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
                                                <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.6 17.6 0 0 0 4.168 6.608 17.6 17.6 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.68.68 0 0 0-.58-.122l-2.19.547a1.75 1.75 0 0 1-1.657-.459L5.482 8.062a1.75 1.75 0 0 1-.46-1.657l.548-2.19a.68.68 0 0 0-.122-.58zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z" />
                                            </svg> Contact us for more details & booking!
                                        </p>
