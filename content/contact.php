...
<head>
    ...
    <meta name="description"
        content="Discover Madagascar, Please feel free to contact us, we are happy to answer all your questions! Send a message.">
...
<body class="bg f">
        ...
        <div class="container">
            <header class="d-flex flex-wrap justify-content-between align-items-center p-2">
                ...
                <ul class="nav d-none d-md-flex col-md-6 justify-content-center mb-2 mb-md-0 mx-auto" id="nav">
                    ...
                    <li><a href="contact.php" class="nav-link px-2 text-white border-bottom border-warning border-2">Contact Us</a>
                    </li>
                </ul>
    ...
    <main class=" shadow-sm bg-light shadow px-0 f ">
        <div id="perso" class="p-5 mb-2 ">

        </div>

        <div class="row mx-5">
            <div class="col-lg-12 text-center " id="nav">
                <a href="https://wa.me/261329572020" target="_blank" class="btn whatsapp rounded-pill mx-2"><svg
                ...
                <a href="personal_adventure.php" class="btn  rounded-pill mx-2 text-white colorbouton"><svg
                        xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-person-gear" viewBox="0 0 16 16">
                        <path
                            d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4m.256 7a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1zm3.63-4.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382zM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0" />
        ...
        <div class="row m-5 pb-5 ">
            <div class="col-12 col-md-7 col-lg-6 mx-auto">
                <div class=" col-lg-8 mx-auto bg-warning bg-opacity-10 shadow-sm border-top border-bottom p-3  mb-4">
                    <h4 class="text-center fs-2 fw-bold titre">SEND A MESSAGE</h4>
                    <p class="text-center">Please feel free to contact us, we are happy to answer all your questions!
                    </p>
                </div>

                <form class="f" action="../assets/data/message.php" method="POST">
                    <div class="row g-3 pb-5">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control f" id="subject" name="subject" placeholder="subject"
                                required>
                        </div>
