...
<head>
    ...
    <title>The Center of Madagascar</title>
    ...
    <div class="position-sticky bg-white shadow-sm raccourci " style="top: 4rem;">
        <div class=" row pb-2 pt-1 ">
            ...
            <div class="col-10  col-lg-11 py-2 bg-white  " style="border-radius: 0 10px 10px 0;">
                ...
                <a href="southWest_of_Madgascar.php" style="text-decoration: none;">South west</a>| Central
    ...
    <main class=" shadow-sm bg-white rounded p-3 shadow">
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../assets/images/antananarivorova.webp" class=" w-100 h-100 car" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../../assets/images/antananarivo.webp" class=" w-100 h-100 car" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../../assets/images/city/Antananarivo.webp" class=" w-100 h-100 car" alt="...">
                </div>

                <div class="carousel-caption">
                    <h1>The Center of Madagascar </h1>
                    <p class="fw-bold">The Heart of the Island</p>
                </div>
            </div>
        ...
        <div class="col-lg-7 mx-auto">
            <div class="text-center py-3">
                ...
                <p>The Merina people, the largest ethnic group in Madagascar, dominate the central region.
                    The area is famous for its terraced rice fields, similar to those in Southeast Asia.
                    Unique burial traditions, including the Famadihana (Turning of the Bones) ceremony.</p> <br>
                <h4>Culture & Traditions</h4>
                <p class="shadow-sm p-3 text-start bg-light ">
                    - The Merina people, the largest ethnic group in Madagascar, dominate the central region. <br>
                    - The area is famous for its terraced rice fields, similar to those in Southeast Asia. <br>
                    - Unique burial traditions, including the Famadihana (Turning of the Bones) ceremony. <br>
                </p>
                <h4>How to Get Around</h4>
                <p class="text-start">
                    By Road – Well-connected highways link Antananarivo to other cities like Antsirabe and
                    Fianarantsoa. <br>
                    By Rail – The Fianarantsoa-Côte Est (FCE) train offers a scenic but slow journey. <br>
                    By Air – Domestic flights connect Tana to other parts of the country. <br>
                </p>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed bg-warning bg-opacity-10 shadow-sm p-3" type="button"
                            ...
                            Main Cities in Central Madagascar
                        </button>
                    </h2>
                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <p>
                                <b>1. Antananarivo (Tana) – The Capital City</b> <br><br>

                                The largest city in Madagascar and the country's political and economic center.
                                Famous for its Rova (Queen’s Palace), Analakely market, and Lemurs’ Park.
                                A mix of modern infrastructure and traditional Malagasy architecture.
                                Bustling markets, colonial-era buildings, and vibrant nightlife. <br><br>
                            <div class="row">
                                <div class="col-6"><img src="../../assets/images/antananarivorova.webp" alt=""
                                        width="100%">
                                </div>
                                <div class="col-6"><img src="../../assets/images/antananarivo.webp" alt="" width="100%">
                                    <br><br>
                                </div>
                            </div>

                            <b>2. Antsirabe – The Spa City</b> <br><br>

                            Known for its thermal springs and colonial charm.
                            Famous for ricksaws (pousse-pousse) and artisanal workshops.
                            The beautiful Tritriva and Andraikiba lakes are nearby. <br><br>
                            <img src="../../assets/images/city/tritriva.webp" alt="" width="100%">
