...
<head>
    ...
    <title>The East of Madagascar</title>
    ...
    <div class="position-sticky bg-white shadow-sm raccourci " style="top: 4rem;">
        <div class=" row pb-2 pt-1 ">
            ...
            <div class="col-10  col-lg-11 py-2 bg-white  " style="border-radius: 0 10px 10px 0;">
                ...
                <a href="southWest_of_Madgascar.php" style="text-decoration: none;">South west</a>| East
    ...
    <main class=" shadow-sm bg-white rounded p-3 shadow">
        ...
        <div id="carouselExample" class="carousel slide">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../assets/images/cameleon.webp" class="w-100 h-100  car " alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../../assets/images/indriindri.webp" class=" w-100 h-100 car" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../../assets/images/city/andasibe1.webp" class=" w-100 h-100 car" alt="...">
                </div>

                <div class="carousel-caption">
                    <h1>The East of Madagascar</h1>
                    <p class="fw-bold">A Tropical Paradise of Rainforests, Beaches, and Unique Wildlife</p>
                </div>
            </div>
        ...
        <div class="col-lg-7 mx-auto">
            <div class="text-center py-3">
                ...
                <p>The eastern coast of Madagascar is known for its lush rainforests, pristine beaches, and incredible
                    biodiversity. This
                    region offers a variety of landscapes, from humid jungles to sandy shores, and is perfect for those
                    who love nature,
                    wildlife, and tranquility. Here’s a guide to the must-see places in the east of Madagascar.</p> <br>
                <h4>Why Explore the East of Madagascar?</h4>
                <p class="shadow-sm p-3 text-start bg-light ">
                    - Rich biodiversity with unique species like lemurs and chameleons <br>
                    - Lush rainforests and serene beaches <br>
                    - Ideal for wildlife enthusiasts, photographers, and nature lovers <br>
            ...
            <div class="accordion " id="accordionFlushExample">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <p>
                                <b>A Lemur Paradise</b> <br>

                                This national park, also known as Perinet, is a haven for wildlife enthusiasts,
                                especially those wanting to see
                                Madagascar’s famous lemurs. <br><br>

                                <b>What to See:</b> <br><br>
                                - The Indri Indri, the largest lemur species, famous for its haunting calls <br>
                                - The Diademed Sifaka, one of the most beautiful lemurs <br>
                                - A variety of reptiles, amphibians, and birds <br>
                            </p>
                            <img src="../../assets/images/indriindri.webp" class="rounded" alt="Andasibe-Mantadia"
                                width="100%">
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseTwo" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <p>
                                <b>Rainforests and Biodiversity</b> <br>
                                The Périnet Reserve is another incredible spot in the east to explore lush rainforests,
                                vibrant flora, and wildlife. <br><br>

                                <b>Highlights:</b> <br><br>
                                - Night walks to spot nocturnal creatures, such as chameleons <br>
                                - Diverse plant life, including orchids and ferns <br>
                                - Birdwatching opportunities with endemic species <br>
                            </p>
                            <img src="../../assets/images/cameleon.webp" alt="Périnet" width="100%">
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="flush-collapseThree" class="accordion-collapse collapse show"
                        ...
                        <div class="accordion-body">
                            <p>
                                ...
                                <b>A Tropical Escape</b> <br>
                                Ile Sainte-Marie is a picturesque island with turquoise waters, palm-fringed beaches,
                                and a laid-back vibe. <br><br>

                                <b>Must-Do Activities:</b><br><br>
                                - Whale watching (from June to September) <br>
                                - Explore the beaches and go snorkeling in the crystal-clear waters <br>
                                - Discover the island’s pirate history and visit the pirate cemetery <br>
                            </p>
                            <img src="../../assets/images/city/stmarie.webp" alt="Tsingy st maria" width="100%">
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse1" class="accordion-collapse collapse show "
                        ...
                        <div class="accordion-body">
                            <p>
                                <b>Madagascar’s Wilderness</b> <br>
                                This UNESCO World Heritage-listed park is one of the largest protected areas in
                                Madagascar, showcasing stunning
                                rainforests, pristine beaches, and coral reefs. <br><br>

                                <b>Why Visit?</b> <br><br>
                                - Trek through dense rainforests filled with rare wildlife <br>
                                - Discover the Masoala Marine Reserve, home to coral reefs and marine life <br>
                                - See Aye-Aye lemurs, a nocturnal and rare species <br>
                            </p>
                            <img src="../../assets/images/city/masoala.webp" alt="masoala" width="100%">
                        </div>
                    </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse2" class="accordion-collapse collapse show "
                        ...
                        <div class="accordion-body">
                            <p>
                                <b>Madagascar’s Port City</b> <br>
                                Tamatave is the second-largest city in Madagascar and an important port. It’s a vibrant
                                city with rich culture, markets,
                                and coastal beauty. <br>

                                <b>What to See:</b><br><br>
                                - The Ivoloina Park, a natural reserve with lemurs and birds <br>
                                - The Foulpointe Beach, perfect for swimming and relaxing <br>
                                - Explore the bustling local markets and the city’s colonial architecture <br>
                            </p>
                            <img src="../../assets/images/city/toamasina.webp" alt="toamasina" width="100%">
                        </div>
                    </div>
                </div>
        ...
        <div class="container px-4" id="custom-cards">
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
                ...
                <div class="col col-lg-4">
                    <a href="../place/center_of_Madagascar.php" class="text-decoration-none ">
                        <div class="card card-cover h-100 text-bg-dark  image-hover"
