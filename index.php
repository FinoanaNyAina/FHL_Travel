...
<body class="bg  f">
    ...
    <header id="" class="header d-flex align-items-center sticky-top bg rounded shadow">
        <div class="container">
            <header class="d-flex flex-wrap justify-content-center justify-content-md-between py-1 mt-2">
                <a href="index.php"
                    class="d-flex align-items-center col-auto col-md-3 mb-2 mb-md-0 text-white text-decoration-none titre fw-bold">
                    <img src="assets/images/logo.jpeg" width="50px" style="border-radius: 20%;margin-right: 5px;"
    ...
    <main class=" shadow-sm bg-white shadow p-0">
        ...
        <div class="text-center mt-5 ">
            <h2 class="d-inline-block mb-2 fw-bold titre text-uppercase color border-bottom txt ">
                Discover Madagascar</h2>
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <p class="mt-4 mb-5 txt">Dive into adventure by discovering Madagascar, a fascinating island full of
                        wonders
                        where
                        every corner of
                        paradise
        ...
        <div class="text-center mb-4 mt-3 ">
            ...
            <p><b>Highly
                    Booked Tours </b> : <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="text-center border-bottom pt-4 mt-3 pb-3">
            <h2 class="d-inline-block mb-2 mt-3 fw-bold text-uppercase titre color border-bottom">
                Plan
                your next visit in Madagascar</h2>
            <div class="col-lg-8 mx-auto">
                <p class="mt-5 ">Planning an adventure in Madagascar with <b class="text-primary-emphasis">FHL Travel</b> means choosing an authentic and unique
        ...
        <div class="text-center pt-5 pb-5 bg-light bg-g border-bottom  ">
            <h2 class="d-inline-block fw-bold titre text-uppercase color border-bottom ">
                Let's build your trip together

            </h2>
            <p class="">To better assist you, we invite you to contact us so we can discuss and build your travel
                project to
                Madagascar with
            ...
            <div class="row pt-4 g-4 justify-content-center ">
                ...
                <div class="col-lg-3">
                    <a href="" class="btn whatsapp fw-bold rounded-pill"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg> +261 34 04 140 40 </a>
                </div>
                <div class="col-lg-3">
                    <a href="" class="btn  mail fw-bold rounded-pill"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="col-lg-4">
                    <a href="" class="btn text-white fw-bold rounded-pill" id="colorButton"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-gear" viewBox="0 0 16 16">
        ...
        <div class="text-center pt-5 mx-5 border-bottom">
            <div>
        ...
        <footer class="pt-5 ">
            <div class="row">
                <div class="col-6 col-md-2 mb-3  ">
                    <img src="assets/images/logo.jpeg" class="rounded-3" width="200px" height="200px" alt="">
                </div>
                <div class="col-6 col-md-2 mb-3 ">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 border-top">
                ...
                <p><a href="assets/data/login.php" class=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-power" viewBox="0 0 16 16">
                            <path d="M7.5 1v7h1V1z" />
                            <path d="M3 8.812a5 5 0 0 1 2.578-4.375l-.485-.874A6 6 0 1 0 11 3.616l-.501.865A5 5 0 1 1 3 8.812" />
                        </svg></a></p>
            </div>
